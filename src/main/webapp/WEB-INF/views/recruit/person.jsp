...
<div class="container-fluid">
<div class="row">
<div class="col-sm-4 col-sm-offset-4" style=" padding:40px 20px 10px 20px;">
<img alt="main" src="img/recruit_person.png" class="img-responsive"></div>
</div>
</div>
<div class="container-fluid" style=" margin:0;padding:0;">
<img alt="main" src="img/person.png" class="img-responsive"></div>
</body>
</html>