...
<div>
	...
	<div class="class="container-fluid"">
		...
		<div class="col-sm-6 col-sm-offset-3" style=" margin:40px;padding:5;">
		<img alt="." src="img/table.png" class="img-responsive"></div>
		<!-- 사진  -->
		<div class="col-sm-4 col-sm-offset-1" style=" margin:200px 30px 10px 30px;padding:5;">
		<img alt="." src="img/customer.png" class="img-responsive"></div>
		</div>
		</div>
	</div>
</div>
