...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="http://localhost:8080/">MAIN</a>
    </div>
	...
	<img alt="main" src="img/contactus_tel_mail.png" class="img-responsive">
	<br>
	</div>

		<div class="col-sm-12 col-sm-offset-2">
	<img alt="main" src="img/contactus_addr.png" class="img-responsive">
	<br>
	</div>

		<div class="col-sm-12 col-sm-offset-2">
	<img alt="main" src="img/contactus_map.png" class="img-responsive">
	</div>
</div>
</div>
</body>
